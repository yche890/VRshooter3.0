...
otherwise accompanies this software in either electfronic or hard copy form.
...
public class OVRCrosshair
{
	...
	public void SetOVRCameraController(ref OVRCameraController cameraController)
	{
        ...
        crosshairPosition = cameraPosition + dir;
	}
	...
	public void UpdateCrosshair()
	{
        ...
        if (CollisionWithGeometryCheck())
        {
            Debug.Log("The crosshair collide with the object" );
	...
	bool CollisionWithGeometryCheck()
	{
        ...
        Debug.DrawLine(cameraPosition, crosshairPosition);
		RaycastHit hit;
        if (Physics.Linecast(cameraPosition, crosshairPosition, out hit)) 
		{
			if (!hit.collider.isTrigger)
			{
                //Debug.Log("Targeting by "+hit.collider.gameObject.name);
